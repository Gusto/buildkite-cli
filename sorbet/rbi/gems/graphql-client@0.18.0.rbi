...
module GraphQL
  class << self
    # source://graphql/2.0.21/lib/graphql.rb#35
    def default_parser; end

    # source://graphql/2.0.21/lib/graphql.rb#39
    def default_parser=(_arg0); end

    # source://graphql/2.0.21/lib/graphql.rb#45
    def parse(graphql_string, trace: T.unsafe(nil)); end

    # source://graphql/2.0.21/lib/graphql.rb#52
    def parse_file(filename); end

    # source://graphql/2.0.21/lib/graphql.rb#62
    def parse_with_racc(string, filename: T.unsafe(nil), trace: T.unsafe(nil)); end

    # source://graphql/2.0.21/lib/graphql.rb#58
    def scan(graphql_string); end

    # source://graphql/2.0.21/lib/graphql.rb#66
